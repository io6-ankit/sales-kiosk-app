...
//             // Agar event inventory, booking, flat add/delete, ya sync ka hai
//             if (
...
//                 fetchInventory(); // Server se latest towers & flats reload karega!
//             }
//         }
//     }, [lastMessage]);

//     // Tower Modal State (Create/Edit)
...
//     // NEW: Add Flat to Floor Modal State
...
//         setTargetFloor(Number(floorNum));
//         // Auto calculate suggested flat number (e.g. Floor 1 -> 105, Floor 2 -> 205)
//         const floorUnits = groupedUnits[floorNum] || [];
//         const nextSeq = floorUnits.length + 1;
//         const suggestedNum = `${floorNum}${String(nextSeq).padStart(2, '0')}`;
...
//     // Submit Handler for Adding a New Flat to Floor
...
//             // Fallback for local update if state is managed synchronously
//             if (currentTower.units) {
//                 currentTower.units.push(newUnitPayload);
//             }

//             showNotification(`Flat #${flatForm.unitNumber} added successfully to Floor ${targetFloor}!`, 'success');
...
//     const groupedUnits = getGroupedUnitsByFloor();
//     const sortedFloors = Object.keys(groupedUnits).sort((a, b) => Number(a) - Number(b));
...
//                             {/* Floor Header Bar with Add Flat Button */}
//                             <Paper
//                                 elevation={0}
//                                 sx={{
//                                     p: 1.5,
...
//                                     {/* Add Flat Button specifically for this Floor */}
//                                     {role === 'CONTROLLER' && (
//                                         <Button
//                                             variant="outlined"
//                                             color="primary"
...
//             {/* MODAL 2: NEW - Add Flat to Floor Modal */}
//             <Dialog
...
//                     <Box>
//                         <Typography variant="h6" fontWeight="bold">
//                             Add New Flat (Floor - {targetFloor})
//                         </Typography>
//                         <Typography variant="caption" color="text.secondary">
//                             Add extra unit/flat to Floor {targetFloor}
//                         </Typography>
//                     </Box>
...
export const InventoryPage = () => {
    ...
    return (
        <Container maxWidth="xl" sx={{ mt: 4, mb: 8 }}>
            ...
            {/* MODAL 2: Add Flat to Floor Modal */}
            <Dialog
                open={addFlatModalOpen}
                onClose={() => setAddFlatModalOpen(false)}
                maxWidth="xs"
